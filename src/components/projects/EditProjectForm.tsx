    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        ...
        <input
          ...
          className="bg-fuchsia-600 hover:bg-fuchsia-800 transition-colors shadow-inner shadow-white/60 w-full p-3 text-white uppercase font-bold rounded cursor-pointer"
        />
      </form>
    </div>
  );
